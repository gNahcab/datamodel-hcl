...
use crate::xlsx_parse::parsed_data_sheet::{data_sheet, ParsedDataSheet};

pub fn import_some_ordered_df<P: AsRef<Path>>(data_path: P, sheet_numbers: &Vec<usize>, sheet_infos: &Vec<SheetInfo>) -> Result<Vec<ParsedDataSheet>, ParsingError> {
    ...
    let mut all_datasheets:Vec<ParsedDataSheet> = vec![];
    let mut nr_ : usize = 0;
...
pub fn import_all_ordered_df<P: AsRef<Path>>(data_path: P, sheet_numbers: &Vec<usize>, sheet_infos: &Vec<SheetInfo>) -> Result<Vec<ParsedDataSheet>, ParsingError> {
